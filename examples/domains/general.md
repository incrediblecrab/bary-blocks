...
**For LLM:** The default. Blog posts, short essays, internal documents, email — everything with no professional register of its own.
...
With `examples/education-levels/`. Describe the reader's familiarity and support needs directly. Use a preset for an appropriate classroom task, not as a generic cure for weak prose or an assumed measure of the reader.
