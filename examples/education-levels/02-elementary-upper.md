...
**For LLM:** An optional classroom preset for grades 4 and 5, adjusted to the reader's actual familiarity and support needs. Connect abstractions to examples and make evidence relationships visible. Neither syntax nor the ability to name a source suddenly begins at this grade band.
...
- Possessive `'s` on a singular noun, a bare apostrophe on a regular plural ending in s, and `'s` on an irregular plural that does not (`the children's books`). Possessive pronouns take no apostrophe.
