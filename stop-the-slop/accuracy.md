...
**For LLM:** Padded or imprecise language misinforms a reader even when no sentence in it is false. Accuracy is therefore a craft obligation in every genre, not a specialty of the regulated ones.
